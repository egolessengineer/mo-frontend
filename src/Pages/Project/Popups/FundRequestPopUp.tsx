...
const FundRequestPopUp = ({ open, close, nextpop }: any) => {
  const release = () => {
    close();
    nextpop();
  };
        ...
        <div className="p-5">
              ...
              <div className="flex flex-col gap-[10px]">
                ...
                <div>
                  ...
                  <Typography
                    label={"-20 $"}
                    type="p"
                    classname="text-text-danger-200 "
                    FontSize="sm"
                  />
                </div>{" "}
                <div>
          ...
          <div className="flex justify-end gap-5 mt-5">
            ...
            <div className="w-[134px]">
              <Button label="Release Fund" size="small" onClick={release} />
            </div>
          </div>
        </div>
      }
...
export default FundRequestPopUp;
