  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      <div className="flex  flex-col items-center mt-[12px]  ">
        ...
        <div className="lg:w-[828px] md:w-[628px] sm:w-[520px] w-[350px] flex mt-[20px] md:space-x-[20px] xs:space-y-[20px] md:space-y-[0px] xs:flex-col xs:items-center md:flex-row">
          {user?.role === "PURCHASER" && <div className="shadow-navbar w-full rounded-[5px] ">
            ...
            <div className="p-[20px]">
              <div className="relative">
                <CustomDropdown
                  ...
                  buttonClassName="w-full h-[40px] border broder-[1px] border-text-gray-50 rounded-[5px] text-text-primary-300 outline-none  text-sm flex justify-between items-center p-[10px]"
